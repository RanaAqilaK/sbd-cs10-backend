...
class TransactionController {
  static async createTransaction(req, res, next) {
    try {
      ...
      console.log(`Redis stream transaction-logs entry created: ${streamId}`);
  ...
  static async payTransaction(req, res, next) {
    try {
      ...
      console.log(`Mencoba bayar transaksi ID: ${id} untuk User ID: ${userId}`);

      const result = await Transaction.pay(Number(id), userId);
